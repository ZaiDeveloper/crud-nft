<template>
  <section>
    <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8">
      <h5 class="font-bold">Owner Collection:</h5>
      <div
      ...
      >
        ...
        >
          <div>
            <div
              class="absolute top-0 right-0 mt-2 mr-2 p-4 z-20 flex justify-between"
            >
              <div
                class="inline-flex items-center justify-center w-8 h-8 p-2 rounded-full bg-white shadow-sm"
              >
                <svg
